...
const MYTH_FIGURES = [
  {
    year: '~350 BCE',
    name: 'Aristotle',
    claim: 'Heavy objects fall because they seek their "natural place" at the center of the universe.',
    note: 'Weight is an immutable, intrinsic property.',
  },
  {
    year: '1638 CE',
    name: 'Galileo Galilei',
    claim: 'Falling bodies accelerate uniformly. Kinematics formalized.',
    note: 'Still framed inside the Aristotelian cosmos.',
  },
  {
    year: '1687 CE',
    name: 'Isaac Newton',
    claim: 'Universal inverse-square law. F = G·m₁m₂/r².',
    note: 'Synthesized Kepler + Galileo into celestial mechanics.',
  },
];

export default function MythSection() {
  const tCommon = useTranslations('Myth.common');
  const t = useTranslations('Myth.gravity');
