    ...
    >
      ...
      <div className="max-w-5xl w-full relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-[18vw] sm:text-[14vw] md:text-[12rem] leading-none text-gradient-gold text-glow-gold">
            1020
          </h2>
        ...
        >
          {/* Scholar portrait card with REAL archival manuscript image */}
          <motion.div
          ...
          >
            {/* Real manuscript illumination */}
            <div className="relative aspect-[3/4] overflow-hidden">
              <Image
                src="/images/sdam-real/biruni-manuscript.jpg"
                alt="Authentic medieval manuscript illumination depicting scholars in a scholarly setting, from a surviving Islamic Golden Age manuscript"
                fill
            ...
            {/* Footer caption — honest provenance */}
            <div className="p-4 pt-3 border-t border-gold/15 bg-cosmos-deep/50">
              <p className="text-[10px] font-mono uppercase tracking-widest text-cream-dim/70 text-center italic">
                Authentic medieval manuscript illumination
              </p>
            </div>
          </motion.div>
          ...
          <div className="relative">
            ...
            <blockquote className="font-display text-xl sm:text-2xl md:text-3xl text-cream leading-relaxed italic pl-8 border-l-2 border-gold/40">
              Objects do not fall to the center of the universe.
              <br />
              <span className="text-gradient-gold">
                They fall to the center of the Earth.
              </span>
              <br />
              And were one far away in space, they would still fall toward it.
            </blockquote>
            <p className="text-cream-dim text-sm mt-4 pl-8">
              — al-Bīrūnī, <em>al-Qānūn al-Masʿūdī</em>, c. 1020 CE
            </p>
            ...
            >
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-cream/85 text-sm">
                  Polymath: astronomy, mathematics, geography, physics.
                </span>
              </div>
              <div className="flex items-baseline gap-2">
                <span className="text-gold text-xs font-mono">02</span>
                <span className="text-cream/85 text-sm">
                  Masterwork: <em>al-Qānūn al-Masʿūdī</em> (Canon Masudicus).
                </span>
              </div>
              <div className="flex items-baseline gap-2">
                <span className="text-gold text-xs font-mono">03</span>
                <span className="text-cream/85 text-sm">
                  Measured Earth&apos;s radius — within 1% of the modern value.
                </span>
              </div>
              <div className="pt-4">
                <p className="text-cream/90 text-base leading-relaxed">
                  With this single move, al-Bīrūnī{' '}
                  <span className="text-gold font-medium">
                    dismantled Aristotle
                  </span>{' '}
                  with measurement, not speculation. He measured the
                  Earth&apos;s radius to within 0.27% of the modern value
                  using the mountain-dip method — then used that radius to
                  define &ldquo;distance from the center&rdquo; as a
                  <span className="text-gold font-medium"> quantitative variable</span>.
                  The paradigm had shifted —{' '}
                  <span className="text-gradient-gold font-semibold">
                    650 years before Newton
                  </span>{' '}
                  — on the strength of trigonometry, not poetry.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        >
          <p className="text-cream-dim text-sm">
            But naming the direction was only the first step.
          </p>
          <p className="text-gold font-display text-xl sm:text-2xl italic mt-2">
            The mathematical proof came a century later.
          </p>
        </motion.div>
      </div>
    </section>
