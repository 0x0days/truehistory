...
export default function OpticsDiscoverySection() {
      ...
      <div className="max-w-5xl w-full relative z-10">
        ...
        >
          ...
          >
            <div className="relative aspect-[3/4] overflow-hidden">
              <Image
                src="/images/sdam-optics/manazir-muslim-heritage.jpg"
                alt="Authentic page from a medieval Arabic optics manuscript showing geometric diagrams and calligraphic text"
                fill
            ...
            <div className="p-4 pt-3 border-t border-gold/15 bg-cosmos-deep/50">
              <p className="text-[10px] font-mono uppercase tracking-widest text-cream-dim/70 text-center italic">
                Authentic medieval Arabic optics manuscript
              </p>
            </div>
          </motion.div>
          ...
          <div className="relative">
            ...
            <blockquote className="font-display text-xl sm:text-2xl md:text-3xl text-cream leading-relaxed italic pl-8 border-l-2 border-gold/40">
              Vision is not caused by rays emitted from the eye.
              <br />
              <span className="text-gradient-gold">
                Light enters the eye from external sources,
              </span>
              <br />
              and forms an image on the lens.
            </blockquote>
            <p className="text-cream-dim text-sm mt-4 pl-8">
              — Ibn al-Haytham, <em>Kitāb al-Manāẓir</em>, c. 1011–1021 CE
            </p>
            ...
            >
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-cream/85 text-sm">
                  Polymath in Cairo, under house arrest by Caliph al-Ḥākim for 10 years.
                </span>
              </div>
              <div className="flex items-baseline gap-2">
                <span className="text-gold text-xs font-mono">02</span>
                <span className="text-cream/85 text-sm">
                  Masterwork: <em>Kitāb al-Manāẓir</em> — 7 volumes of experimental optics.
                </span>
              </div>
              <div className="flex items-baseline gap-2">
                <span className="text-gold text-xs font-mono">03</span>
                <span className="text-cream/85 text-sm">
                  Proved light travels in straight lines, using the camera obscura.
                </span>
              </div>
              <div className="pt-4">
                <p className="text-cream/90 text-base leading-relaxed">
                  ...
                  <span className="text-gold font-medium">
                    destroyed two Greek theories at once
                  </span>{' '}
                  — Euclid&apos;s &ldquo;vision is emitted&rdquo; and Ptolemy&apos;s
                  &ldquo;eye sends rays.&rdquo; He replaced speculation with
                  <span className="text-gold font-medium"> reproducible
                  experiments</span> — the camera obscura, the dark room, the
                  pinhole. The paradigm had shifted —{' '}
                  <span className="text-gradient-gold font-semibold">
                    683 years before Newton&apos;s Opticks
                  </span>{' '}
                  — on the strength of geometry and observation, not poetry.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        >
          <p className="text-cream-dim text-sm">
            But the laws themselves — the actual mathematical theorems — came next.
          </p>
          <p className="text-gold font-display text-xl sm:text-2xl italic mt-2">
            Ibn al-Haytham wrote them down.
          </p>
        </motion.div>
      </div>
    </section>
