...
const MYTH_FIGURES = [
  {
    year: '~300 BCE',
    name: 'Euclid',
    claim: 'Vision is emitted from the eye in straight lines. Geometric optics begins.',
    note: 'Emission theory — light does not yet exist as a physical phenomenon.',
  },
  {
    year: '~150 CE',
    name: 'Ptolemy',
    claim: 'Refines the emission theory. Measures angles of refraction empirically.',
    note: 'Still believes the eye sends out rays.',
  },
  {
    year: '1604 CE',
    name: 'Johannes Kepler',
    claim: 'Publishes the modern theory of the retinal image. Vision by intake.',
    note: 'Built directly on Alhazen\'s Kitāb al-Manāẓir.',
  },
  {
    year: '1704 CE',
    name: 'Isaac Newton',
    claim: 'Opticks. Prism decomposition of white light. Corpuscular theory.',
    note: 'Credited with "discovering optics" in most textbooks.',
  },
  {
    year: '1839 CE',
    name: 'Louis Daguerre',
    claim: 'Announces the daguerreotype. "Invents photography."',
    note: 'Niepce made the first photograph in 1822 — Daguerre commercialized.',
  },
];

export default function OpticsMythSection() {
  const tCommon = useTranslations('Myth.common');
  const t = useTranslations('Myth.optics');
