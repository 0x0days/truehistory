...
const MYTH_FIGURES = [
  {
    year: '~350 BCE',
    name: 'Aristotle',
    claim: 'Systematic observation of nature. Deductive reasoning from first principles.',
    note: 'Often called "the first scientist" — but his method rejected experiment.',
  },
  {
    year: '1620 CE',
    name: 'Francis Bacon',
    claim: 'Novum Organum. Inductive method. "Knowledge is power." Credited with inventing the scientific method.',
    note: 'Textbooks mark this as the birth of modern science.',
  },
  {
    year: '1637 CE',
    name: 'René Descartes',
    claim: 'Discourse on Method. Rationalist method. Systematic doubt. Cogito ergo sum.',
    note: 'Co-credited with founding modern philosophy of science.',
  },
  {
    year: '1934 CE',
    name: 'Karl Popper',
    claim: 'The Logic of Scientific Discovery. Falsifiability criterion.',
    note: 'Refined the modern demarcation of science from non-science.',
  },
];

export default function MethodMythSection() {
  const tCommon = useTranslations('Myth.common');
  const t = useTranslations('Myth.method');
      ...
      <div className="max-w-5xl w-full">
        ...
        >
          ...
          <p className="mt-6 text-cream-dim max-w-2xl mx-auto text-base sm:text-lg">
            Open any philosophy-of-science textbook. The story begins with
            Francis Bacon in 1620 — the year he published <em>Novum Organum</em>{' '}
            and supposedly invented the scientific method. Everything before
            that is dismissed as &ldquo;pre-scientific.&rdquo;
          </p>
        </motion.div>
        ...
        >
          ...
          <h3 className="font-display text-3xl sm:text-5xl md:text-6xl text-cream leading-tight max-w-3xl mx-auto">
            {t('problem1')}
            <span className="text-gradient-gold italic"> {t('problemHighlight')} </span>
            {t('problem2')}
          </h3>
          <motion.div
            initial={{ width: 0 }}
