...
const PILLARS: Pillar[] = [
  {
    ...
    maxPoints: 3,
    evidence:
      'Surviving Arabic manuscripts of Ibn al-Haytham\'s On the Measurement of the Paraboloid and Sharaf al-Ṭūsī\'s On Equations in Istanbul (Süleymaniye) and Tehran (Majlis). Critical editions exist.',
    detail:
      'Ibn al-Haytham\'s treatise edited by Rashed (1993). Sharaf al-Ṭūsī\'s equations analyzed by Rashed (1986). The Sanskrit Kerala school manuscripts are held in Indian and British collections.',
    image: '/images/sdam-calculus/haytham-math-muslim-heritage.jpg',
    imageAlt:
      'Authentic medieval Arabic mathematics manuscript page',
  },
  {
    id: 2,
    roman: 'II',
    ...
    maxPoints: 3,
    evidence:
      'Ibn al-Haytham c. 1000 CE precedes Newton\'s Principia (1687) by 666 years. Sharaf al-Ṭūsī c. 1170 precedes Newton\'s fluxions (1666) by 496 years. Mādhava c. 1400 precedes Leibniz\'s series (1676) by 276 years.',
    detail:
      'All three priority margins exceed the 200-year "definitive" threshold. Dating confirmed by internal astronomical references, contemporary biographical dictionaries, and manuscript colophons.',
  },
  {
    id: 3,
    roman: 'III',
    ...
    maxPoints: 3,
    evidence:
      'Ibn al-Haytham\'s mathematics was transmitted via Latin translation. Newton\'s teacher Isaac Barrow knew the Arabic tradition. Newton himself owned and annotated works derived from Alhazen. The Mādhava tradition was NOT transmitted to Europe.',
    detail:
      'The Arabic→Latin→European chain is documented for Ibn al-Haytham and Sharaf al-Ṭūsī. The Kerala school\'s work appears to have been independent rediscovery by Newton and Leibniz — no documented transmission chain exists.',
  },
  {
    id: 4,
    roman: 'IV',
    ...
    maxPoints: 3,
    evidence:
      'Ibn al-Haytham: limit of a sum (integration). Sharaf al-Ṭūsī: derivative criterion for maxima (differentiation). Mādhava: infinite power series (Taylor series). All three core components of calculus are present in pre-Newtonian non-European manuscripts.',
    detail:
      'Newton and Leibniz\'s genuine contribution was the Fundamental Theorem of Calculus (connecting differentiation and integration) and the notation. The component theorems were already in writing.',
  },
  {
    id: 5,
    roman: 'V',
    ...
    maxPoints: 3,
    evidence:
      'For Ibn al-Haytham and Sharaf al-Ṭūsī: documented transmission via Latin translation, taught at European universities. For Mādhava: NO documented transmission — likely independent rediscovery.',
    detail:
      'The Arabic tradition\'s transmission is solid. The Indian tradition\'s is not. This is a mixed pillar — strong for two of the three traditions, weak for the third.',
  },
  {
    id: 6,
    roman: 'VI',
    ...
    maxPoints: 3,
    evidence:
      '"Calculus" comes from Latin "calculus" (small stone) — a Roman term for counting. No Arabic or Sanskrit loanword survives in the discipline\'s vocabulary. "Algorithm" survives (from al-Khwārizmī) but is from algebra, not calculus.',
    detail:
      'The terminology was fully Romanized. Unlike "algebra" or "algorithm," calculus has no visible Arabic/Sanskrit etymological fingerprint.',
  },
  {
    id: 7,
    roman: 'VII',
    ...
    maxPoints: 3,
    evidence:
      'Roshdi Rashed (1911–2018, the leading historian of Islamic mathematics) explicitly credits Ibn al-Haytham and Sharaf al-Ṭūsī. George Sarton, J. L. Berggren, and Victor Katz all acknowledge the Arabic precursors.',
    detail:
      'The scholarly consensus is settled. The Kerala school\'s priority is acknowledged but its independence from European development is still debated. Textbook coverage lags scholarly consensus by decades.',
  },
];
...
export default function CalculusPillarsSection() {
              ...
              {allFlipped ? (
                ...
                >
                  ...
                  <p className="text-cream-dim text-xs leading-relaxed">
                    Integration (Ibn al-Haytham), differentiation (Sharaf al-Ṭūsī),
                    infinite series (Mādhava): <span className="text-gold">all in writing</span>{' '}
                    pre-Newton. Newton+Leibniz unified + invented notation.
                    The library theft proves transmission.
                  </p>
