...
const MYTH_FIGURES = [
  {
    year: '~250 BCE',
    name: 'Archimedes',
    claim: 'Method of exhaustion. Computed areas and volumes by limits.',
    note: 'The Greek precursor. Lost for centuries, then rediscovered.',
  },
  {
    year: '1666 CE',
    name: 'Isaac Newton',
    claim: 'Develops "fluxions" — his version of calculus. Credited as co-inventor.',
    note: 'Did not publish until 1687 (Principia) and 1693 (De Quadratura).',
  },
  {
    year: '1684 CE',
    name: 'Gottfried Leibniz',
    claim: 'Publishes "Nova Methodus" — first calculus paper. Co-credited as inventor.',
    note: 'His notation (dy/dx, ∫) survives in modern mathematics.',
  },
  {
    year: '1821 CE',
    name: 'Augustin-Louis Cauchy',
    claim: 'Rigorizes the limit. Formal definition of continuity and derivative.',
    note: 'Refines what Newton and Leibniz left loose.',
  },
];

export default function CalculusMythSection() {
  const tCommon = useTranslations('Myth.common');
  const t = useTranslations('Myth.calculus');
