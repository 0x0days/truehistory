...
export default function CalculusVerdictSection() {
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background:
            'radial-gradient(circle at center, rgba(212,175,55,0.16) 0%, transparent 50%)',
        }}
      />
          ...
          {showVerdict && (
            ...
            >
              <p className="text-cream text-base sm:text-lg leading-relaxed">
                The historical record is unambiguous. The three foundational
                techniques of calculus —{' '}
                <span className="text-gradient-gold font-semibold">integration (Ibn al-Haytham, c. 1000)</span>,{' '}
                <span className="text-gradient-gold font-semibold">differentiation (Sharaf al-Ṭūsī, c. 1170)</span>, and{' '}
                <span className="text-gradient-gold font-semibold">infinite series (Mādhava, c. 1400)</span>{' '}
                — were in writing, in Arabic and Sanskrit, centuries before
                Newton and Leibniz.
              </p>
              <p className="text-cream-dim text-sm sm:text-base leading-relaxed">
                Newton and Leibniz&apos;s genuine contribution was unifying
                these techniques through the Fundamental Theorem of Calculus
                and inventing a workable notation. That is a real breakthrough
                — but it is a synthesis, not an invention from nothing. The
                manuscripts they worked from reached Europe by conquest: the
                Crusades, the fall of Granada, Napoleon&apos;s Egypt
                expedition, and British colonial rule in India. The Arabic
                authors were renamed &ldquo;Alhazen.&rdquo; The Sanskrit
                authors were unnamed. The European &ldquo;discoverers&rdquo;
                took the credit. The pattern is consistent across 800 years.
              </p>
            </motion.div>
          )}
        </AnimatePresence>
