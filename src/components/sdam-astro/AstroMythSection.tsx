...
const MYTH_FIGURES = [
  {
    year: '~150 CE',
    name: 'Ptolemy',
    claim: 'Almagest. Geocentric model with epicycles and deferents. The standard astronomy for 1,400 years.',
    note: 'Greek precursor. Refined but not overturned by Islamic astronomers.',
  },
  {
    year: '1543 CE',
    name: 'Nicolaus Copernicus',
    claim: 'De Revolutionibus. Heliocentric model. Credited with "inventing" the Sun-centered universe.',
    note: 'His planetary models use devices identical to al-Ṭūsī and Ibn al-Shāṭir.',
  },
  {
    year: '1610 CE',
    name: 'Galileo Galilei',
    claim: 'Sidereus Nuncius. Telescope observations of Jupiter\'s moons, lunar craters, Milky Way structure.',
    note: 'Credited with "discovering" the Milky Way is made of stars — al-Sufi described it 646 years earlier.',
  },
  {
    year: '1609 CE',
    name: 'Johannes Kepler',
    claim: 'Astronomia Nova. Elliptical orbits. Laws of planetary motion.',
    note: 'Used al-Battānī\'s observational data, transmitted through Tycho Brahe.',
  },
];

export default function AstroMythSection() {
  const tCommon = useTranslations('Myth.common');
  const t = useTranslations('Myth.astro');
