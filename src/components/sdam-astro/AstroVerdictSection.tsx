...
export default function AstroVerdictSection() {
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background: 'radial-gradient(circle at center, rgba(212,175,55,0.18) 0%, transparent 50%)',
        }}
      />
      ...
      <div className="max-w-4xl w-full relative z-20 text-center">
        ...
        <div className="relative mb-4">
          <AnimatePresence mode="wait">
            ...
            >
              {Math.round(score)}
              <span className="text-cream-dim/40 text-[14vw] sm:text-[10vw] md:text-[7rem]">/21</span>
            </motion.div>
          </AnimatePresence>
        </div>
          ...
          {showVerdict && (
            ...
            >
              <p className="text-cream text-base sm:text-lg leading-relaxed">
                ...
                astronomical discoveries — the Andromeda Galaxy (al-Sūfī, 964
                CE), the Tusi Couple (al-Ṭūsī, 1247 CE), the precise lunar
                model (Ibn al-Shāṭir, 1350 CE), the precise solar year
                (al-Battānī, 900 CE) — were{' '}
                <span className="text-gradient-gold font-semibold">
                  in writing, in Arabic, centuries before Copernicus
                </span>
                .
              </p>
              <p className="text-cream-dim text-sm sm:text-base leading-relaxed">
                Copernicus&apos;s genuine contribution was the heliocentric
                framework — placing the Sun at the center. That is a real
                conceptual breakthrough. But the planetary devices he used to
                make the model work — the Tusi Couple, Ibn al-Shāṭir&apos;s
                lunar model, al-Battānī&apos;s data — were in manuscripts that
                reached Italy through Toledo (1085), the fall of Constantinople
                (1453), and the Andalusian diaspora. Copernicus cited
                al-Battānī 23 times. He did not cite al-Ṭūsī or Ibn al-Shāṭir.
                The mathematical identity is documented. The pattern is consistent.
              </p>
            </motion.div>
          )}
        </AnimatePresence>
