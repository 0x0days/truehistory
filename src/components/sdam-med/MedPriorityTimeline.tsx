      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="relative h-[460px] mb-12">
          ...
          <motion.div style={{ opacity: gap1 }} className="absolute top-1/2 -translate-y-1/2 h-12 -mt-6">
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "0px 0px 50% 0px" }} transition={{ delay: 0.6 }} className="absolute -top-9 left-1/2 -translate-x-1/2 text-center" style={{ left: `${(positionFor(1025) + positionFor(1543)) / 2}%` }}><p className="font-display text-2xl sm:text-3xl text-gradient-gold whitespace-nowrap">518 years</p><p className="text-[10px] font-mono uppercase tracking-widest text-gold/70">Canon → Vesalius</p></motion.div>
          </motion.div>
